...
// "home"/"story"/"contact" have their own dedicated editors; "new" is the
// admin route for creating a page and would otherwise collide with a page
// literally named "new".
export const RESERVED_SLUGS = new Set(["home", "story", "contact", "new"]);
