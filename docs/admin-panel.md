...
- `app/admin/` — the admin UI: `/admin/wines` (list, new, edit), `/admin/categories` (list, new, edit), `/admin/menu` (list grouped by location, new, edit), `/admin/pages` (registered pages + admin-created pages, new, edit/delete for the latter), and `/admin/news` (list, new, edit/delete).
- `app/api/admin/` — the API routes the admin UI calls: `login`, `logout`, `wines` create, `wines/[slug]` update/delete, `categories` create, `categories/[id]` update/delete, `menu` create, `menu/[id]` update/delete, `pages` create, `pages/[slug]` update/delete, `news` create, `news/[slug]` update/delete, `upload` (images to R2), and `translate`.
