...
export default function Terroir() {
  return <main><div className="editorial-heading"><p className="eyebrow">Our vineyards / Kakheti, Georgia</p><h1>A place<br />like no other.</h1><p>Every soil, every slope, every season.<br />A different voice in the glass.</p></div><div className="terroir-cover"><img src="/images/vineyard.webp" alt="Alaverdi Monastery and the vineyards of Kakheti beneath the Caucasus Mountains" fetchPriority="high" /><span>Alazani Valley / Kakheti</span></div><section className="terroir-intro"><p className="eyebrow">The character of Kakheti</p><h2>One region.<br />Many expressions.</h2><p>Our vineyards extend across Kakheti, with holdings of up to 500 hectares. Changing altitudes, soils and microclimates create a rich range of expressions from Georgia’s native grapes.</p></section><section id="selected-locations" className="vineyard-list" aria-labelledby="selected-locations-title"><div className="list-heading"><h2 id="selected-locations-title" className="eyebrow">Selected locations</h2><span>The soil. The grape. The character.</span></div><VineyardList places={places} /></section><section className="terroir-closing"><img src="/images/vineyard.webp" alt="Vineyards stretching toward the Caucasus Mountains" loading="lazy" /><div><p className="eyebrow">From the land to the glass</p><h2>Take a little<br />Georgia with you.</h2><Link href="/catalogue" className="underlined-link">Discover the collection <ArrowUpRight size={16} /></Link></div></section></main>;
}
